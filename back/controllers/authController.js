...
const home_url = process.env.PORT || "http://localhost:3000";
    ...
    if (err) {
      ...
      if (data.length > 0) {
        const mailOptions = {
          ...
          html: `<p>You can change your pass here</p><br><a href="${home_url}/${data[0].email}/resetpassword" target="_blank">Link Here</a>`,
        };
